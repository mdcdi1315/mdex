...
public final class BiomeSpawnsModifier
{
    ...
    public void ApplyChanges()
    {
        ...
        for (var entry : entries.entrySet())
        {
            ...
            WeightedList.Builder<MobSpawnSettings.SpawnerData> data = WeightedList.builder();
            ...
            for (var e : entry.getValue())
            {
                ent = e.Entity;
                data.add(
                        new MobSpawnSettings.SpawnerData(ent , e.min , e.max),
                        e.weight
                );
                sc = e.Costs;
                if (sc != null)
            ...
            if (old != null && !old.isEmpty()) {
                for (var olde : old.unwrap()) {
                    data.add(olde.value() , olde.weight());
                }
            }
            spawners.put(category , data.build());
        }
        try {
