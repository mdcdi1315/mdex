        ...
        extends NoiseProvider
{
    ...
    public DualNoiseProvider(InclusiveRange<Integer> variety, Holder<NormalNoise.NoiseParameters> slowNoiseParameters, float slowScale, long seed, Holder<NormalNoise.NoiseParameters> parameters, float scale, List<CompilableTargetBlockState> states)
    {
