 ...
 */
public abstract class ModdedFeature
        <TCONFIG extends ModdedFeatureConfiguration>
    extends Feature<TCONFIG>
{
    ...
    public final boolean place(FeaturePlaceContext<TCONFIG> fpc)
    {
        ...
        return (!fpc.config().isInvalid()) && placeModdedFeature(fpc);
    }
    ...
    public final boolean place(TCONFIG config, WorldGenLevel level, ChunkGenerator cg, RandomSource random, BlockPos origin)
    {
        ...
        return ((!config.isInvalid()) && level.ensureCanWrite(origin)) && placeModdedFeature(
