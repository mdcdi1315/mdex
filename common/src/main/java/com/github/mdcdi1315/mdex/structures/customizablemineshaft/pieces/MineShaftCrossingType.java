...
public final class MineShaftCrossingType
    extends AbstractStructurePieceType
{
    public static final MineShaftCrossingType INSTANCE = new MineShaftCrossingType();

    private MineShaftCrossingType() {
        super("mineshaft_crossing");
    }

    @Override
    protected StructurePiece LoadImpl(StructurePieceSerializationContext sc, CompoundTag ct) {
        return new MineShaftCrossing(ct);
    }
}
