        ...
        extends AbstractMineshaftPiece
{
        ...
        public MineShaftRoom(int genDepth, RandomSource random, int x, int z, CustomizableMineshaftStructureSettings s) {
            super(s, MineShaftRoomType.INSTANCE, genDepth, new BoundingBox(x, MineshaftPieces.MAGIC_START_Y, z, x + 7 + random.nextInt(6),  54 + random.nextInt(6), z + 7 + random.nextInt(6)));
        }
