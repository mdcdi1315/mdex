...
public final class MineShaftRoomType
    extends AbstractStructurePieceType
{
    public static final MineShaftRoomType INSTANCE = new MineShaftRoomType();

    private MineShaftRoomType() {
        super("mineshaft_room");
    }

    @Override
    protected StructurePiece LoadImpl(StructurePieceSerializationContext sc, CompoundTag ct) {
        return new MineShaftRoom(ct);
    }
}
