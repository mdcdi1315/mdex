...
{
    public static final String MAGIC = PerDimensionWorldDataManager.EXPECTED_SAVED_DATA_PREFIX + "MDEX_SAVEDWORLDDATA";
    ...
    private void LoadV1(CompoundTag ct)
    {
        if (ct.contains("teleporter_data" , Tag.TAG_COMPOUND)) {
            ...
            MDEXModInstance.LOGGER.error("WORLDDIMSAVEDATA: Cannot deserialize the specified spawn data file because the 'teleporter_data' field does not exist or is invalid.");
        }
    }
