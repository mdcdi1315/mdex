...
import com.github.mdcdi1315.mdex.features.config.ModdedGeodeConfigurationDetails;
...
public final class ModdedGeodeFeature
    extends ModdedFeature<ModdedFeatureConfiguration<ModdedGeodeConfigurationDetails>>
{
    public ModdedGeodeFeature(Codec<ModdedFeatureConfiguration<ModdedGeodeConfigurationDetails>> codec) {
        super(codec);
    }

    @Override
    protected boolean PlaceModdedFeature(FeaturePlaceContext<ModdedFeatureConfiguration<ModdedGeodeConfigurationDetails>> fpc)
    {
        ModdedGeodeConfigurationDetails geodeconfiguration = fpc.config().Details;
