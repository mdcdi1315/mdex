...
{
    public ModdedLegacyOreFeature(Codec<ModdedFeatureConfiguration<ModdedOreFeatureConfigurationDetails>> codec) {
        super(codec);
    }
    ...
    private boolean doPlace(WorldGenLevel level, RandomSource random, ModdedOreFeatureConfigurationDetails config, double minX, double maxX, double minZ, double maxZ, double minY, double maxY, int x, int y, int z, int width, int height)
    {
        byte j = config.Size;
