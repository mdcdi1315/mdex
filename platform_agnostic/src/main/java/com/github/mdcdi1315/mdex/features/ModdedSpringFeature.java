...
import com.github.mdcdi1315.mdex.features.config.ModdedSpringFeatureConfigurationDetails;
...
public final class ModdedSpringFeature
    extends ModdedFeature<ModdedFeatureConfiguration<ModdedSpringFeatureConfigurationDetails>>
{
    public ModdedSpringFeature(Codec<ModdedFeatureConfiguration<ModdedSpringFeatureConfigurationDetails>> codec) {
        super(codec);
    }

    @Override
    protected boolean PlaceModdedFeature(FeaturePlaceContext<ModdedFeatureConfiguration<ModdedSpringFeatureConfigurationDetails>> fpc) {
        ModdedSpringFeatureConfigurationDetails springconfiguration = fpc.config().Details;
