...
public final class ModdedGeodeConfigurationDetails
    implements IModdedFeatureConfigurationDetails
{
    ...
    public static MapCodec<ModdedGeodeConfigurationDetails> GetCodec()
    {
        ...
        return CodecUtils.CreateMapCodecDirect(
                ...
                ModdedGeodeConfigurationDetails::new
        );
    }

    public ModdedGeodeConfigurationDetails(
