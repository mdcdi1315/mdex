    ...
    extends WeightedEntityEntry
{
    ...
    public WeightedCountedEntityEntry(ResourceLocation loc, int t , IntProvider ct)
    {
        super(loc, t);
        Count = ct;
    }
    ...
    public static Codec<WeightedCountedEntityEntry> GetCountedCodec()
    {
        return CodecUtils.CreateCodecDirect(
                ...
                CodecUtils.ZERO_OR_POSITIVE_INTEGER.optionalFieldOf("weight", 1).forGetter((WeightedCountedEntityEntry e) -> e.weight),
